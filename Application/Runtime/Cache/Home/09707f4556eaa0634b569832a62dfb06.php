...
<body>
    ...
    <div class="training">
        <div class="training-safe">
            ...
            <span style="margin:3px 0;display:block;width:100%;height:50px;float:left;line-height:50px;color:#8A2BE2;font-size:20px;background:#fff;border-top:2px solid #8A2BE2;">
            ...
            <!-- 内训流程结束 -->
            <span style="margin:3px 0;margin-top:40px;display:block;width:100%;height:50px;float:left;line-height:50px;color:#8A2BE2;font-size:20px;background:#fff;border-top:2px solid #8A2BE2;">
