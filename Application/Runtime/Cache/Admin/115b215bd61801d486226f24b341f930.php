					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/amiba/index.php/Admin/Ambnews/mod" enctype="multipart/form-data">
									<div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 新闻标题 </label>
													
                                            <div class="col-sm-9">

                                                <input type="text" name="title" id="form-field-1" value="<?php echo ($ambnews["title"]); ?>" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="username" value="<?php echo ($ambnews["username"]); ?>" id="form-field-1"  class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <img src="/amiba/Public/Upload/<?php echo ($ambnews["icon"]); ?>" width=180 height=120 alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="file" name="icon" id="form-field-1" value="<?php echo ($ambnews["abstract"]); ?>" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 新闻摘要 </label>
                                                    
                                            <div class="col-sm-9">

                                                <input type="text" name="abstract" id="form-field-1" value="<?php echo ($ambnews["abstract"]); ?>" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">新闻内容</label>

                                            <div class="col-sm-9">
                                                 <textarea name="content" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); echo ($ambnews["content"]); ?></textarea>
                                            </div>
                                        </div>
                                        
                                         <div class="space-4"></div>
                                        <input type="hidden" name="id" value="<?php echo ($ambnews["id"]); ?>">
                                         <div class="space-4"></div>
									<div class="space-4"></div>
