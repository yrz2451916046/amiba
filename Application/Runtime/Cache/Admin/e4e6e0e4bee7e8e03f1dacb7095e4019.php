...
<div class="main-content">
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/index.php/Admin/Ambnews/index">
							<div>
								<span>新闻标题：</span>
								<input type="text" name="title" placeholder="请输入新闻标题" class="nav-search-input" id="nav-search-input" autocomplete="off" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/index.php/Admin/Ambnews/del" method="post">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>编号</th>
														<th style="width:220px;">新闻标题</th>
														<th style="width:80px;">发布者</th>
														<th style="width:220px;">新闻图片</th>
												...
												<tbody>
												<?php if(is_array($ambnews)): foreach($ambnews as $key=>$vo): ?><tr>
														<td class="center">
															<label>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/index.php/Admin/Ambnews/status/id/<?php echo ($vo["id"]); ?>/status/<?php echo ($vo["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/index.php/Admin/Ambnews/mod/id/<?php echo ($vo["id"]); ?>">
																	<i class="icon-pencil bigger-110">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/index.php/Admin/Ambnews/del/id/<?php echo ($vo["id"]); ?>">
