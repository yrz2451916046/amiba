...
<div class="main-content">
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/amiba/index.php/Admin/Ambnews/index">
							<div>
								<span>新闻标题：</span>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/amiba/index.php/Admin/Ambnews/del" method="post">
												...
												<?php if(is_array($ambnews)): foreach($ambnews as $key=>$vo): ?><tr>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/amiba/index.php/Admin/Ambnews/status/id/<?php echo ($vo["id"]); ?>/status/<?php echo ($vo["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/amiba/index.php/Admin/Ambnews/mod/id/<?php echo ($vo["id"]); ?>">
																	<i class="icon-pencil bigger-110">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/amiba/index.php/Admin/Ambnews/del/id/<?php echo ($vo["id"]); ?>">
