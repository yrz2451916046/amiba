        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/index.php/Admin/Carousel/add" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content">
                                    <div id="home4" class="tab-pane in active">
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 轮播图标题 </label>
													
                                            <div class="col-sm-9">

                                                <input type="text" name="title" id="form-field-1" placeholder="轮播图标题" class="col-xs-10 col-sm-5 " />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 轮播图片 </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="url" id="form-field-1" placeholder="链接地址" class="col-xs-10 col-sm-5 " />
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
			$("[name='tid']").change(function(){
				...
				if(val == 0){
					...
					var url="/index.php/Admin/Carousel/search/id/"+val;
					$.get(url,function(d){
						//alert(d);
						html = "";
						var data = eval("("+d+")");
            ...
            $('#form-field-select-2').change(function() {
                ...
                $.ajax({
                    url: "/index.php/Admin/Carousel/getChildCate/",
