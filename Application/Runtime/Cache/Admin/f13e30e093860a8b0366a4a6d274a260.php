                                    ...
                                    <div id="home4" class="tab-pane in active">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="title" id="form-field-1" placeholder="新闻标题" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="username" id="form-field-1"  class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="abstract" id="form-field-1" placeholder="新闻摘要" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 <textarea name="content" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); ?></textarea>
                                            </div>
                                        </div>
