        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/index.php/Admin/Traincourse/add" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                                    ...
                                    <div id="home4" class="tab-pane in active">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" name="name" id="form-field-1" placeholder="输入课程标题" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="starttime" id="datetimepicker" placeholder="输入开始时间" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
										<div class="space-4"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="输入地区" name="area" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="输入地址" name="address" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="输入出行" name="goout" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="输入语言" name="language" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" placeholder="输入咨询" name="consult" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                               <textarea name="overview" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea name="lecintroduce" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 <textarea name="discount" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 <textarea name="outline" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); ?></textarea>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
			$("[name='tid']").change(function(){
				...
				if(val == 0){
					...
					var url="/index.php/Admin/Traincourse/search/id/"+val;
					$.get(url,function(d){
						//alert(d);
						html = "";
						var data = eval("("+d+")");
            ...
            $('#form-field-select-2').change(function() {
                ...
                $.ajax({
                    url: "/index.php/Admin/Traincourse/getChildCate/",
