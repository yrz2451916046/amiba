...
<div class="main-content">
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/amiba/index.php/Admin/Incourse/index">
							<div>
								<span>内训案例标题：</span>
								<input type="text" name="title" placeholder="请输入内训案例标题" class="nav-search-input" id="nav-search-input" autocomplete="off" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/amiba/index.php/Admin/Incourse/del" method="post">
										<div class="table-responsive">
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($incourse)): foreach($incourse as $key=>$vo): ?><tr>
														<td class="center">
															<label>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/amiba/index.php/Admin/Incourse/status/id/<?php echo ($vo["id"]); ?>/status/<?php echo ($vo["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/amiba/index.php/Admin/Incourse/mod/id/<?php echo ($vo["id"]); ?>">
																	<i class="icon-pencil bigger-110">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/amiba/index.php/Admin/Incourse/del/id/<?php echo ($vo["id"]); ?>">
