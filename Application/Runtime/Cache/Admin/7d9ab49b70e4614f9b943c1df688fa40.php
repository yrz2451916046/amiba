...
<div class="main-content">
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/index.php/Admin/Carousel/index">
							<div>
								<span>轮播图标题：</span>
								<input type="text" name="title" placeholder="请输入轮播图标题" class="nav-search-input" id="nav-search-input" autocomplete="off" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/index.php/Admin/Carousel/del" method="post">
												...
												<?php if(is_array($carousel)): foreach($carousel as $key=>$vo): ?><tr>
														...
														<td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/index.php/Admin/Carousel/status/id/<?php echo ($vo["id"]); ?>/status/<?php echo ($vo["status"]); ?>">
																	<i class="icon-lock">
																...
																<a class="green" href="/index.php/Admin/Carousel/mod/id/<?php echo ($vo["id"]); ?>">
																	<i class="icon-pencil bigger-110">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/index.php/Admin/Carousel/del/id/<?php echo ($vo["id"]); ?>">
