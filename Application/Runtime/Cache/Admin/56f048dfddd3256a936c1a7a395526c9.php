...
<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/index.php/Index/index.html">后台主页</a>
							</li>
					...
					<div class="page-content">
						...
						<!--搜索-->
						<form class="form-search" method="get" action="/index.php/Admin/Traincourse/index">
							<div>
								<span>课程标题：</span>
								<input type="text" name="name" placeholder="请输入课程标题" class="nav-search-input" id="nav-search-input" autocomplete="off" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<form action="/index.php/Admin/Traincourse/del" method="post">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>编号</th>
														<th style="width:120px;">课程标题</th>
														<th style="width:120px;">课程图片</th>
														<th >
														地区
														</th>
												...
												<tbody>
												<?php if(is_array($traincourse)): foreach($traincourse as $key=>$course): ?><tr>
														<td class="center">
															<label>
														...
														<td><?php echo ($course["icon"]); ?></td>
														<td><?php echo ($course["area"]); ?></td>
														<td><?php echo ($course["address"]); ?></td>
														<td class="hidden-480"><?php echo ($course["goout"]); ?></td>
														<td class="hidden-480"><?php echo (date("Y-m-d H:i:s",$course["starttime"])); ?></td>
														<td class="hidden-480"><?php echo ($course["language"]); ?></td>
														<td class="hidden-480"><?php echo ($course["consult"]); ?></td>
														<td class="hidden-480"><?php if($course["status"] == '1'): ?>激活<?php else: ?>禁用<?php endif; ?></td>
														<td class="hidden-480"><?php echo (date("Y-m-d H:i:s",$course["addtime"])); ?></td>
														<td>
														
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="/index.php/Admin/Traincourse/status/id/<?php echo ($course["id"]); ?>/status/<?php echo ($course["status"]); ?>">
																	<i class="icon-lock">
																		<?php if($course["status"] == '1'): ?>禁用<?php else: ?>激活<?php endif; ?>
																	
																	</i>
																	
																</a>

																<a class="green" href="/index.php/Admin/Traincourse/mod/id/<?php echo ($course["id"]); ?>">
																	<i class="icon-pencil bigger-110">修改</i>
																	
																</a>

																<a class="red" onclick="return confirm('你确认要删除吗')" href="/index.php/Admin/Traincourse/del/id/<?php echo ($course["id"]); ?>">
