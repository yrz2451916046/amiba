...
<html lang="en">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/index.php/Admin/Traincourse/mod" enctype="multipart/form-data">
									<div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 课程标题 </label>
													
                                            <div class="col-sm-9">

                                                <input type="text" name="name" id="form-field-1" value="<?php echo ($traincourse["name"]); ?>" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 新闻原图片 </label>
                                                    
                                            <div class="col-sm-9">

                                                <img src="/Public/Upload/<?php echo ($traincourse["icon"]); ?>" width=180 height=120 alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="file" name="icon" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="starttime" id="datetimepicker" value="<?php echo (date('Y-m-d H:i:s',$traincourse["starttime"])); ?>" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">地区</label>

                                            <div class="col-sm-9">
                                                <input type="text" value="<?php echo ($traincourse["area"]); ?>" name="area" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">地址</label>

                                            <div class="col-sm-9">
                                                <input type="text" name="address" value="<?php echo ($traincourse["address"]); ?>" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">出行</label>

                                            <div class="col-sm-9">
                                                <input type="text" name="goout" value="<?php echo ($traincourse["goout"]); ?>" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">语言</label>

                                            <div class="col-sm-9">
                                                <input type="text" name="language" value="<?php echo ($traincourse["language"]); ?>" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">咨询</label>

                                            <div class="col-sm-9">
                                                <input type="text" name="consult" value="<?php echo ($traincourse["consult"]); ?>" class="col-xs-10 col-sm-5">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">概述</label>

                                            <div class="col-sm-9">
                                               <textarea name="overview" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); echo ($traincourse["overview"]); ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">讲师介绍</label>

                                            <div class="col-sm-9">
                                                <textarea name="lecintroduce" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); echo ($traincourse["lecintroduce"]); ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">费用及优惠</label>

                                            <div class="col-sm-9">
                                                 <textarea name="discount" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); echo ($traincourse["discount"]); ?></textarea>
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-11">纲要</label>

                                            <div class="col-sm-9">
                                                 <textarea name="outline" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); echo ($traincourse["outline"]); ?></textarea>
                                            </div>
                                        </div>
                                        <input type="hidden" name="id" value="<?php echo ($traincourse["id"]); ?>">
                                         <div class="space-4"></div>
									<div class="space-4"></div>
    ...
    KindEditor.ready(function(K) {
      ...
      var editor2 = K.create('textarea[name="lecintroduce"]', {
        cssPath : '/Public/Home/plugins/code/prettify.css',
        uploadJson : '/Public/Home/upload_json.php',
        fileManagerJson : '/Public/Home/file_manager_json.php',
        allowFileManager : true,
      ...
      var editor2 = K.create('textarea[name="discount"]', {
        cssPath : '/Public/Home/plugins/code/prettify.css',
        uploadJson : '/Public/Home/upload_json.php',
        fileManagerJson : '/Public/Home/file_manager_json.php',
        allowFileManager : true,
