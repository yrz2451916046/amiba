        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="/amiba/index.php/Admin/Lecturer/add" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="tabbable">
                                ...
                                <div class="tab-content">
                                    <div id="home4" class="tab-pane in active">
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 讲师名称 </label>
													
                                            <div class="col-sm-9">

                                                <input type="text" name="name" id="form-field-1" placeholder="输入讲师名称" class="col-xs-10 col-sm-5" valType="required" msg="<font color=red>*</font>讲师名称不能为空" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 <textarea name="introduce" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); ?></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="clearfix form-actions">
                            <div class="col-md-offset-3 col-md-9">
                                <input type="submit"  name="sub" id='btn'  value="添加" class="btn btn-info">
                            </div>
                        </div>
        ...
        <script type="text/javascript">
			$("[name='tid']").change(function(){
				...
				if(val == 0){
					...
					var url="/amiba/index.php/Admin/Lecturer/search/id/"+val;
					$.get(url,function(d){
						//alert(d);
						html = "";
						var data = eval("("+d+")");
            ...
            $('#form-field-select-2').change(function() {
                ...
                $.ajax({
                    url: "/amiba/index.php/Admin/Lecturer/getChildCate/",
