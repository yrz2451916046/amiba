					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="/amiba/index.php/Admin/Lecturer/mod">
									<div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 讲师名称 </label>
                          
                                            <div class="col-sm-9">

                                                <input type="text" name="name" id="form-field-1" value="<?php echo ($lecturer["name"]); ?>" class="col-xs-10 col-sm-5" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-4"></div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                 <textarea name="introduce" style="width:80%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($htmlData); echo ($lecturer["introduce"]); ?></textarea>
                                            </div>
                                        </div>
